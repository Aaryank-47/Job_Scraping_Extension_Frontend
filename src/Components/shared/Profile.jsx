  ...
  return (
    <div className="profile-container">
      ...
      >
        {page === 1 ? (
          <>
            <h2 className="header2">Basic Details</h2>
            <p className="para">Enter your basic details to create your profile</p>
            <form>
          ...
          <>
            <h2 className="header2" >Professional Background</h2>
            <p className="para" >Enter details about your work experience and skills</p>
            <form onSubmit={handleSubmit}>
              <textarea  className = "textarea" name="workExperience" placeholder="Work Experience (if any)" onChange={handleChange}></textarea>

              <div className="radio-group">
                <label>Currently Working?</label>
                <input className="input" type="radio" name="workingState" value="Yes" onChange={handleChange} /> Yes
                <input className="input" type="radio" name="workingState" value="No" onChange={handleChange} /> No
              </div>

              <div className="input-group">
                <input className="input" type="text" name="college" placeholder="College / University" onChange={handleChange} />
              </div>

              <input className="input" type="text" name="skills" placeholder="Key Skills" onChange={handleChange} />
              <input className="input" type="text" name="preferredJobs" placeholder="Preferred Jobs (e.g., Full-time, Freelance)" onChange={handleChange} />
